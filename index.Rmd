...
* Open source contributor (author of 1.5 [R packages](https://rdrr.io/github/josephsdavid/tswgewrapped/) and 1 [python package](https://pypi.org/project/n2d/), as well as 2 somewhat widely used covid research packages)
...
Important note, I am having some serious issues with systme fonts lately, therefore some graphics may look a bit funny...
...
* Writing
* Explainable Models
* Parametrized Deep Learning
* Time Series
* My dog

# Things I am doing

* Dropping everything to work on COVID-19
  * Direct contributions:
    * [Tools for parsing COVID papers](https://pypi.org/project/cord-19-tools/)
    * [Tools for covid modeling](https://pypi.org/project/covid-modeling/)

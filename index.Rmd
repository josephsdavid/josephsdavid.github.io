...
* Working on my master's thesis (Unsupervised and Supervised Learning for MS Diagnoses):
  * Build SVM and LSTM based classifiers using gait data to assess the ordinality of EDSS scores in MS patients
  * Clustering gait data to build a new mobility metric for MS patients.

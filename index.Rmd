...
* Working on my capstone project (Unsupervised and Supervised Learning for MS Diagnoses):
  * Build SVM and LSTM based classifiers using gait data to determine EDSS score computationally
  * Cluster gait data to build a new mobility metric for MS patients as well as highlight relationships between other MS phenotypes and gait
...
* Maintaining and growing my first large python library
